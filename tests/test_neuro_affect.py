...
class TestNeuroChemicalEngine(unittest.TestCase):
    ...
    def test_chemicals_never_exceed_one(self) -> None:
        for _ in range(10):
            self.engine.apply_stimulus(reward=1.0, threat=1.0, success=1.0,
                                        uncertainty=1.0, frustration=1.0)
    ...
    def test_emotional_intensity_at_baseline_is_low(self) -> None:
        # Brand-new engine is at baseline; intensity should be near zero
    ...
    def test_emotional_intensity_accepts_precomputed_pad(self) -> None:
        ...
        # Both should be close (minor float differences are OK)
    ...
    def test_metabolize_does_not_overshoot_baseline(self) -> None:
        self.engine.chemicals.dopamine = 0.0  # below baseline 0.5
